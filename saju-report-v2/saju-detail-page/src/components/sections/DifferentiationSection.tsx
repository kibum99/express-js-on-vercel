...
import { diffContent } from '../../content/content';
import { SectionTitle, Card, DiffPoint } from '../ui';

export function DifferentiationSection() {
  const prefersReducedMotion = useReducedMotion();
  const { difference, comparison, diffPoints } = diffContent;
  ...
  return (
    <section className="relative px-6 py-14 md:py-20 overflow-hidden z-10">
      <div className="max-w-md mx-auto text-center">
        ...
        >
          저희는 그 차이를 알고,<br />
          처음부터 <strong className="text-accent">새롭게 설계</strong>했습니다.
        </motion.p>
